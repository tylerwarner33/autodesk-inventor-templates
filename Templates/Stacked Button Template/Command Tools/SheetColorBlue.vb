...
Module SheetColorBlue
    ...
    Function CreateButton(
        ...
        Dim largeIcon As IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.BlueColor_32)
        Dim standardIcon As IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.BlueColor_16)
        Dim toolTipImage As IPictureDisp = Nothing

        ' This is the text the user sees on the button.
        Dim buttonLabel As String = "Sheet Color" & vbLf & "Blue"
...
#End Region
    ...
    Sub RunCommandCode()
        ...
        drawingDocument.SheetSettings.SheetColor = transientObjects.CreateColor(160, 175, 255)
