...
Module CreateSketchedSquareCircle
...
#End Region
    ...
    Sub RunCommandCode()
        ...
        Dim symbolName As String = "Square Circle Symbol"
        ...
        drawingSketch.SketchCircles.AddByCenterRadius(transientGeometry.CreatePoint2d(5, 5), 1)
        ...
        drawingDocument.ActiveSheet.SketchedSymbols.Add(symbolName, transientGeometry.CreatePoint2d(5, 15))
