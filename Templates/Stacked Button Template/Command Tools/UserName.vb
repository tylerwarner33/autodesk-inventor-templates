...
Module UserName
    ...
    Function CreateButton(
        ...
        Dim largeIcon As IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.Rooster_32)
        Dim standardIcon As IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.Rooster_16)
        Dim toolTipImage As IPictureDisp = Nothing

        ' This is the text the user sees on the button.
        Dim buttonLabel As String = "Check" & vbLf & "User Name"

        ' Text that displays when the user hovers over the button.
        Dim toolTipSimple As String = "Displays the user name"
        Dim toolTipExpanded As String = Nothing

#Region "Progressive ToolTip"

        'sSet to true to use a progressive tool tip, and false to a simple tool tip.
...
#End Region
    ...
    Sub RunCommandCode()
        MsgBox(_inventorApplication.GeneralOptions.UserName)
    End Sub
